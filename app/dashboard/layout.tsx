    ...
    <div className="min-h-screen flex" style={{ background: "#F4F7FA" }}>
      <aside className="w-60 flex flex-col fixed h-full" style={{ background: "#0E2436" }}>
        ...
        <nav className="flex-1 px-3 py-4 space-y-0.5">
          <p className="text-xs font-semibold uppercase tracking-wider px-3 py-2" style={{ color: "#41566B", letterSpacing: "0.1em" }}>General</p>
          <Link href="/dashboard" className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors hover:text-white group" style={{ color: "#A9BED2" }}>
          ...
          <Link href="/dashboard/empresas" className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors hover:text-white group" style={{ color: "#A9BED2" }}>
