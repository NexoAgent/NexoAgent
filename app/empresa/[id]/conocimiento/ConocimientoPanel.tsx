  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-white rounded-xl p-6" style={{ border: "1px solid #E2E9F0" }}>
        <h2 className="font-semibold font-sora text-sm mb-1" style={{ color: "#0E2436" }}>
          Agregar documento
        </h2>
        ...
        <div className="flex gap-2 mb-4">
          {[{ key: "archivo", label: "📎 Subir archivo" }, { key: "texto", label: "✏️ Pegar texto" }].map((m) => (
            <button
              ...
              style={{
                background: modo === m.key ? "#0E2436" : "white",
                color: modo === m.key ? "white" : "#41566B",
                borderColor: modo === m.key ? "#0E2436" : "#E2E9F0",
              }}
            >
              {m.label}
            </button>
        ...
        {modo === "archivo" ? (
          <div
            ...
            style={{
              border: `2px dashed ${arrastrandoEncima ? "#2B82F0" : "#E2E9F0"}`,
              background: arrastrandoEncima ? "rgba(43,130,240,0.04)" : "#F4F7FA",
            }}
          >
            ...
            <p className="text-sm font-medium" style={{ color: "#0E2436" }}>
              {arrastrandoEncima ? "Suelta el archivo aquí" : "Arrastra un archivo o haz clic"}
            </p>
            <p className="text-xs mt-1" style={{ color: "#73869A" }}>PDF o TXT · se indexa automáticamente</p>
        ...
        {subiendo && modo === "archivo" && (
          <p className="text-xs text-center mt-3" style={{ color: "#2B82F0" }}>
      ...
      {/* Lista de documentos */}
      {documentos.length > 0 && (
        <div className="bg-white rounded-xl" style={{ border: "1px solid #E2E9F0" }}>
          <div className="px-5 py-4" style={{ borderBottom: "1px solid #F4F7FA" }}>
            ...
            {documentos.map((d) => (
              <div key={d.id} className="flex items-center gap-4 px-5 py-4">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium truncate" style={{ color: "#0E2436" }}>{d.nombre}</p>
                ...
                <div className="flex items-center gap-3 flex-shrink-0">
                  {d._count.chunks > 0 ? (
                    <span className="flex items-center gap-1.5 text-xs px-2.5 py-1 rounded-full font-medium"
                      style={{ background: "rgba(34,178,107,0.08)", color: "#22B26B", border: "1px solid rgba(34,178,107,0.2)" }}>
